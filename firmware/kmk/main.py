...
keyboard.keymap = [
    ...
    [
      LOCK, KC.MB_RMB, KC.MS_UP, KC.MB_LMB, KC.MW_UP, KC.PGUP, KC.HOME, KC.UP, KC.END, UNDO,
      PRV_WND, KC.MS_LT, KC.MS_DN, KC.MS_RT, KC.MW_DN, KC.PGDN, KC.LEFT, KC.DOWN, KC.RGHT, COPY,
      KC.CW, BREAK, OS_LALT, OS_LCTL, GUI_ALT, PRV_TAB, NXT_TAB, FSCRN, KC.INS, PASTE,
      KC.RESET, KC.NO, KC.TRNS, SSHOT, KC.TAB, KC.DEL
    ],
    [
